...
@section('content')
  ...
  <div class="row g-3 mb-3">
    <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">{{ __('Status') }}</div><div class="h5 mb-0"><x-badge :variant="$badgeMap[$batch->status] ?? 'neutral'">{{ ucfirst($batch->status) }}</x-badge></div></div></div></div>
