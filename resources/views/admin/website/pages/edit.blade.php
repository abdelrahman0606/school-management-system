...
@section('content')
  @php
    ...
    $spec = [
      ...
      'announcement_bar' => [
        ['key'=>'text','label'=>'Message','input'=>'text','placeholder'=>'Admissions open for 2026-27'],
        ['key'=>'link_text','label'=>'Link text (optional)','input'=>'text','placeholder'=>'Apply now'],
        ['key'=>'link_url','label'=>'Link URL (optional)','input'=>'text'],
        ['key'=>'dismissible','label'=>'Dismissible','input'=>'switch','default'=>true],
      ],
      'faq'           => [['key'=>'heading','label'=>'Heading','input'=>'text'],['key'=>'faq_items','label'=>'Questions & answers (Question|Answer per line)','input'=>'textarea']],
    ...
    $blockIcons = [
      ...
      'recent_notices' => 'bi-bell', 'announcement_bar' => 'bi-broadcast', 'faq' => 'bi-question-circle',
